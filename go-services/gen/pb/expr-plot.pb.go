...
type AxisLines int32

const (
	AxisLines_AXIS_LINES_BOX    AxisLines = 0
	AxisLines_AXIS_LINES_LEFT   AxisLines = 1
	AxisLines_AXIS_LINES_RIGHT  AxisLines = 2
	AxisLines_AXIS_LINES_MIDDLE AxisLines = 3
	AxisLines_AXIS_LINES_CENTER AxisLines = 4
	AxisLines_AXIS_LINES_NONE   AxisLines = 5
)

// Enum value maps for AxisLines.
var (
	AxisLines_name = map[int32]string{
		0: "AXIS_LINES_BOX",
		1: "AXIS_LINES_LEFT",
		2: "AXIS_LINES_RIGHT",
		3: "AXIS_LINES_MIDDLE",
	...
	AxisLines_value = map[string]int32{
		"AXIS_LINES_BOX":    0,
		"AXIS_LINES_LEFT":   1,
		"AXIS_LINES_RIGHT":  2,
		"AXIS_LINES_MIDDLE": 3,
...
func (x AxisLines) Enum() *AxisLines {
	p := new(AxisLines)
	*p = x
	return p
}

func (x AxisLines) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AxisLines) Descriptor() protoreflect.EnumDescriptor {
	return file_expr_plot_proto_enumTypes[0].Descriptor()
}

func (AxisLines) Type() protoreflect.EnumType {
	return &file_expr_plot_proto_enumTypes[0]
}

func (x AxisLines) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AxisLines.Descriptor instead.
func (AxisLines) EnumDescriptor() ([]byte, []int) {
...
type ExprPlotRequest struct {
	...
	AxisLines AxisLines         `protobuf:"varint,7,opt,name=axis_lines,proto3,enum=plot.AxisLines" json:"axis_lines,omitempty"`
	Border    int32             `protobuf:"varint,8,opt,name=border,proto3" json:"border,omitempty"`
	Grid      bool              `protobuf:"varint,9,opt,name=grid,proto3" json:"grid,omitempty"`
	Title     string            `protobuf:"bytes,10,opt,name=title,proto3" json:"title,omitempty"`
	Plots     []*PlotExpression `protobuf:"bytes,11,rep,name=plots,proto3" json:"plots,omitempty"`
}
...
func (x *ExprPlotRequest) GetAxisLines() AxisLines {
	if x != nil {
		return x.AxisLines
	}
	return AxisLines_AXIS_LINES_BOX
}
...
var file_expr_plot_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x6c, 0x65, 0x67, 0x65, 0x6e, 0x64, 0x22, 0xb6, 0x02, 0x0a, 0x0f, 0x45, 0x78, 0x70,
	...
	,
}
...
var file_expr_plot_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_expr_plot_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_expr_plot_proto_goTypes = []interface{}{
	(AxisLines)(0),           // 0: plot.AxisLines
	(*PlotExpression)(nil),   // 1: plot.PlotExpression
	(*ExprPlotRequest)(nil),  // 2: plot.ExprPlotRequest
	(*ExprPlotResponse)(nil), // 3: plot.ExprPlotResponse
}
var file_expr_plot_proto_depIdxs = []int32{
	0, // 0: plot.ExprPlotRequest.axis_lines:type_name -> plot.AxisLines
	1, // 1: plot.ExprPlotRequest.plots:type_name -> plot.PlotExpression
	2, // 2: plot.ExpressionPlotService.GeneratePlot:input_type -> plot.ExprPlotRequest
	3, // 3: plot.ExpressionPlotService.GeneratePlot:output_type -> plot.ExprPlotResponse
...
func file_expr_plot_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_expr_plot_proto_enumTypes,
