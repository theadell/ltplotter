...
const (
	ExpressionPlotService_GeneratePlot_FullMethodName = "/plot.ExpressionPlotService/GeneratePlot"
)
...
func (c *expressionPlotServiceClient) GeneratePlot(ctx context.Context, in *ExprPlotRequest, opts ...grpc.CallOption) (*ExprPlotResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExpressionPlotService_GeneratePlot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedExpressionPlotServiceServer must be embedded to have
...
func (UnimplementedExpressionPlotServiceServer) testEmbeddedByValue()                               {}
...
func RegisterExpressionPlotServiceServer(s grpc.ServiceRegistrar, srv ExpressionPlotServiceServer) {
	// If the following call pancis, it indicates UnimplementedExpressionPlotServiceServer was
...
func _ExpressionPlotService_GeneratePlot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExpressionPlotService_GeneratePlot_FullMethodName,
	}
